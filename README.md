...
Welcome to my collection of projects built while exploring **C#** and the **.NET framework**.  
This repo is more than code—it’s a snapshot of my growth as a developer.
